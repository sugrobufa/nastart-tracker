...
Pool length (25m/50m) is auto-detected from PDF headers."""
...
OUTPUT_FILE = os.path.join(REPO_ROOT, "scripts", "pdf_parsed_results.json")
...
# ============================================================
# Method 1: pdfplumber (single-line layout)
# ============================================================
...
# ============================================================
# Method 2: PyMuPDF multi-line parsing (fallback)
# ============================================================
...
# ============================================================
def main():
    import pdfplumber  # noqa: ensure available
    import fitz  # noqa: ensure available
